"""
Django settings for starlink_isp project.
...
SECRET_KEY = 'django-insecure-lw2cdvd3g=%ae%clm#$&pgf$tn_$z2_(po7ryf6afcw_7i!er_'
...
WSGI_APPLICATION = 'starlink_isp.wsgi.application'
